...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/210907_025720/0000/tree_59.root  --datayear 2016 --outputfile $1_TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_2016_ext1803.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_2016_ext1803.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_2016_ext1803.root 

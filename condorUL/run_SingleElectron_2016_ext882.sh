...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/SingleElectron/Run2016D-02Apr2020-v1/210907_043212/0000/tree_10.root  --datayear 2016 --outputfile $1_SingleElectron_2016_ext882.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_SingleElectron_2016_ext882.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_SingleElectron_2016_ext882.root 

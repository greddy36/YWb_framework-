...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/DYJetsToLL_M-50_HT-400to600_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_102X_upgrade2018_realistic_v21_ext2-v1/210907_040922/0000/tree_6.root  --datayear 2018 --outputfile $1_DYJetsToLL_M-50_HT-400to600_2018_ext73.root --nque 5 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_DYJetsToLL_M-50_HT-400to600_2018_ext73.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_DYJetsToLL_M-50_HT-400to600_2018_ext73.root 

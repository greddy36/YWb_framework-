...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/DYJetsToLL_M-50_HT-400to600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/210907_030652/0000/tree_2.root  --datayear 2016 --outputfile $1_DYJetsToLL_M-50_HT-400to600_2016_ext31.root --nque 5 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_DYJetsToLL_M-50_HT-400to600_2016_ext31.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_DYJetsToLL_M-50_HT-400to600_2016_ext31.root 

...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/EGamma/Run2018D-02Apr2020-v1/210810_035129/0000/tree_229.root  --datayear 2018 --outputfile $1_EGamma_2018_ext1152.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_EGamma_2018_ext1152.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_EGamma_2018_ext1152.root 

...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2017-VER2/TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_new_pmx_102X_mc2017_realistic_v8-v1/210809_065509/0000/tree_68.root  --datayear 2017 --outputfile $1_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_2017_ext1322.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/SAMPLE" 

xrdcp -f $1_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_2017_ext1322.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/$1_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_2017_ext1322.root 

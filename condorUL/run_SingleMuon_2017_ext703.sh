...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2017-VER2/SingleMuon/Run2017C-02Apr2020-v1/210907_045355/0000/tree_29.root  --datayear 2017 --outputfile $1_SingleMuon_2017_ext703.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/SAMPLE" 

xrdcp -f $1_SingleMuon_2017_ext703.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/$1_SingleMuon_2017_ext703.root 

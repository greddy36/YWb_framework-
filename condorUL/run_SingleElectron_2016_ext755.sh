...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/SingleElectron/Run2016B_ver2-Nano1June2019_ver2-v1/210904_172424/0000/tree_21.root  --datayear 2016 --outputfile $1_SingleElectron_2016_ext755.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_SingleElectron_2016_ext755.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_SingleElectron_2016_ext755.root 

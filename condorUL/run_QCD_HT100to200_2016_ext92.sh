...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/QCD_HT100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/210914_040906/0000/tree_15.root  --datayear 2016 --outputfile $1_QCD_HT100to200_2016_ext92.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_QCD_HT100to200_2016_ext92.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_QCD_HT100to200_2016_ext92.root 

...
python analyse_with_mva_batch.py --inputfile INFILE --datayear YEAR --outputfile $1_OUTFILE --nque QUEUE --npro $1
...
xrdcp -f $1_OUTFILE root://cmseos.fnal.gov/OUTPUT/$1_OUTFILE

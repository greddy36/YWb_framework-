...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2017-VER2/TTWJetsToLNu_TuneCP5_PSweights_13TeV-amcatnloFXFX-madspin-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_new_pmx_102X_mc2017_realistic_v8-v1/210809_065605/0000/tree_35.root  --datayear 2017 --outputfile $1_TTWJetsToLNu_2017_ext1583.root --nque 5 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/SAMPLE" 

xrdcp -f $1_TTWJetsToLNu_2017_ext1583.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/$1_TTWJetsToLNu_2017_ext1583.root 

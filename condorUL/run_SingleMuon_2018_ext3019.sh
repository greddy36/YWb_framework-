...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/SingleMuon/Run2018C-Nano25Oct2019-v1/210904_175530/0000/tree_3.root  --datayear 2018 --outputfile $1_SingleMuon_2018_ext3019.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_SingleMuon_2018_ext3019.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_SingleMuon_2018_ext3019.root 

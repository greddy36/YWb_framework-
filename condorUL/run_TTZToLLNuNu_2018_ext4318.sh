...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/TTZToLLNuNu_M-10_TuneCP5_13TeV-amcatnlo-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_102X_upgrade2018_realistic_v21_ext1-v1/210907_040527/0000/tree_17.root  --datayear 2018 --outputfile $1_TTZToLLNuNu_2018_ext4318.root --nque 5 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_TTZToLLNuNu_2018_ext4318.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_TTZToLLNuNu_2018_ext4318.root 

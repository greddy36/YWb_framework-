...
applyTopPtRew =  False
useDeepCSV = False
#sfFilePath  = "root://cmsxrootd.fnal.gov//store/user/amodak//store/user/greddy/condorAtanu"
doSys = True
doSkim = True
...
def applyHEM(file, entry, j):
  ...
  return flag
#guru
sf_file = ROOT.TFile.Open("root://cmsxrootd.fnal.gov//store/user/greddy/condorAtanu/ElectronTrigSF"+year+".root")
...
def fillSkim(skimName):
    ...
    sktree.Branch("EvtWt_nominal", EvtWt_nominal, 'EvtWt_nominal/F')
...
for i in  range(1):
  ...
  #reader.BookMVA(TString("TMVA::BDT"), TString("root://cmseos.fnal.gov//store/user/greddy/condorAtanu/TMVAClassification_BDT.weights.xml"))
  ...
  for entry in tree:
    ...
    if (isMC(file)):
      ...
      if (doSys):
        ...
        print("evtwt_Mu_Trig_Sf_Up: ",evtwt_Mu_Trig_Sf_Up)
          ...
          if (itr == 16):
            ...
            if (doSys):
              ...
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "TTJets_ST_ScalingDown", evtwt_TTJets_ST_ScalingDown)    
               #guru
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Electron_IDISO_Sf_Up", evtwt_Ele_IDISO_Sf_Up)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Electron_IDISO_Sf_Down", evtwt_Ele_IDISO_Sf_Down)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Electron_RECO_Sf_Up", evtwt_Ele_RECO_Sf_Up)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Electron_RECO_Sf_Down", evtwt_Ele_RECO_Sf_Down)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Electron_Trig_Sf_Up", evtwt_Ele_Trig_Sf_Up)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Electron_Trig_Sf_Down", evtwt_Ele_Trig_Sf_Down)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Muon_Trig_Sf_Up", evtwt_Mu_Trig_Sf_Up)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Muon_Trig_Sf_Down", evtwt_Mu_Trig_Sf_Down)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Muon_ID_Sf_Up", evtwt_Mu_ID_Sf_Up)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Muon_ID_Sf_Down", evtwt_Mu_ID_Sf_Down)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Muon_ISO_Sf_Up", evtwt_Mu_ISO_Sf_Up)
              fillHisto(str(controlR[cr]), str(ch), file, entry, itr, nBTag, MassT, Mt_js, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), entry.event_LeadJet_pt,  "Muon_ISO_Sf_Down",  evtwt_Mu_ISO_Sf_Down)
             
          if (itr == 4 and doSkim and "PreSig" in str(controlR[cr])):
            #Nominal 
            loadSkimTree(file, entry, event_genwt, leadjetBTag, MassT, HT_Central, HT_Full_pu_var, HT_Full_nopu_var, neles, nmuons, evtwt_nominal, evtwt_PileupUp, evtwt_PileupDown, evtwt_BTaghfSFUp, evtwt_BTaghfSFDown, evtwt_BTaglfSFUp, evtwt_BTaglfSFDown, evtwt_LHEScaleUpWeight, evtwt_LHEScaleDownWeight, evtwt_LHEPdfUpWeight, evtwt_LHEPdfDownWeight, evtwt_TTJets_ST_ScalingUp, evtwt_TTJets_ST_ScalingDown, lepClosestJet_v2_4vec, Lep4vec, Met4vec, leadJet_4vec, leadjetBTagTig, FwdJetPt_T, fwdJeteta_T, Mt_js, Mw_js, MET_pt(file, entry, "nominal"), entry.event_LeadJet_pt,evtwt_Ele_IDISO_Sf_Up, evtwt_Ele_IDISO_Sf_Down, evtwt_Ele_RECO_Sf_Up, evtwt_Ele_RECO_Sf_Down, evtwt_Ele_Trig_Sf_Up, evtwt_Ele_Trig_Sf_Down, evtwt_Mu_Trig_Sf_Up, evtwt_Mu_Trig_Sf_Down, evtwt_Mu_ID_Sf_Up, evtwt_Mu_ID_Sf_Down, evtwt_Mu_ISO_Sf_Up,
evtwt_Mu_ISO_Sf_Down)
            sktree.Fill()

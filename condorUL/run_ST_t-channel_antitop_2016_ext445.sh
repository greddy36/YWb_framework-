...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/ST_t-channel_antitop_4f_inclusiveDecays_13TeV_PSweights-powhegV2-madspin/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/210907_030332/0000/tree_80.root  --datayear 2016 --outputfile $1_ST_t-channel_antitop_2016_ext445.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_ST_t-channel_antitop_2016_ext445.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_ST_t-channel_antitop_2016_ext445.root 

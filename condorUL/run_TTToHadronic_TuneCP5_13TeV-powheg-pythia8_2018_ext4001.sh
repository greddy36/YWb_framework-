...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_102X_upgrade2018_realistic_v21_ext2-v1/210907_040233/0000/tree_6.root  --datayear 2018 --outputfile $1_TTToHadronic_TuneCP5_13TeV-powheg-pythia8_2018_ext4001.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_TTToHadronic_TuneCP5_13TeV-powheg-pythia8_2018_ext4001.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_TTToHadronic_TuneCP5_13TeV-powheg-pythia8_2018_ext4001.root 

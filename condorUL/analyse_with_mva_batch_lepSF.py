    ...
    if (isMC(file)):
      ...
      if (year  == "2016"):
          if (float(entry.event_Event_flag) == 13 and float(entry.event_MuonTrigFlag) >= 1):
            ...
            #guru
            evtwt_Mu_ID_Sf_Up *= float((0.45*float(entry.Muon_ID_GH_SFstatUp[entry.event_Lepton_idx]))+(0.55*float(entry.Muon_ID_BCDEF_SFstatUp[entry.event_Lepton_idx])))*float((0.45*float(entry.Muon_ID_GH_SFsystUp[entry.event_Lepton_idx]))+(0.55*float(entry.Muon_ID_BCDEF_SFsystUp[entry.event_Lepton_idx])))/float(idsf)
            evtwt_Mu_ISO_Sf_Up *= np.add(np.multiply(0.45,entry.Muon_ISO_GH_SFstatUp[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_ISO_BCDEF_SFstatUp[entry.event_Lepton_idx]))*np.add(np.multiply(0.45,entry.Muon_ISO_GH_SFsystUp[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_ISO_BCDEF_SFsystUp[entry.event_Lepton_idx]))/float(isosf)
            evtwt_Mu_Trig_Sf_Up *= np.add(np.multiply(0.45,entry.Muon_Trigger_GH_SFstatUp[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_Trigger_BCDEF_SFstatUp[entry.event_Lepton_idx]))*np.add(np.multiply(0.45,entry.Muon_Trigger_GH_SFsystUp[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_Trigger_BCDEF_SFsystUp[entry.event_Lepton_idx]))/float(trigsf)
            #guru
            evtwt_Mu_ID_Sf_Down *= float((0.45*float(entry.Muon_ID_GH_SFstatDown[entry.event_Lepton_idx]))+(0.55*float(entry.Muon_ID_BCDEF_SFstatDown[entry.event_Lepton_idx])))*float((0.45*float(entry.Muon_ID_GH_SFsystDown[entry.event_Lepton_idx]))+(0.55*float(entry.Muon_ID_BCDEF_SFsystDown[entry.event_Lepton_idx])))/float(idsf)
            evtwt_Mu_ISO_Sf_Down *= np.add(np.multiply(0.45,entry.Muon_ISO_GH_SFstatDown[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_ISO_BCDEF_SFstatDown[entry.event_Lepton_idx]))*np.add(np.multiply(0.45,entry.Muon_ISO_GH_SFsystDown[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_ISO_BCDEF_SFsystDown[entry.event_Lepton_idx]))/float(isosf)
            evtwt_Mu_Trig_Sf_Down *= np.add(np.multiply(0.45,entry.Muon_Trigger_GH_SFstatDown[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_Trigger_BCDEF_SFstatDown[entry.event_Lepton_idx]))*np.add(np.multiply(0.45,entry.Muon_Trigger_GH_SFsystDown[entry.event_Lepton_idx]), np.multiply(0.55,entry.Muon_Trigger_BCDEF_SFsystDown[entry.event_Lepton_idx]))/float(trigsf)
            ...
            #guru
            evtwt_Ele_IDISO_Sf_Up     *= float(entry.Electron_IDISO_BCDEFGH_SFstatUp[entry.event_Lepton_idx])*float(entry.Electron_IDISO_BCDEFGH_SFsystUp[entry.event_Lepton_idx])/float(idisosf)
            evtwt_Ele_RECO_Sf_Up      *= float(entry.Electron_RECO_BCDEFGH_SFstatUp[entry.event_Lepton_idx])*float(entry.Electron_RECO_BCDEFGH_SFsystUp[entry.event_Lepton_idx])/float(recosf)
            evtwt_Ele_Trig_Sf_Up      *= float(Ele_trig_SF(entry.Electron_eta[el], entry.Electron_pt[el],"Up"))/float(trigsf)
            #guru
            evtwt_Ele_IDISO_Sf_Down     *= float(entry.Electron_IDISO_BCDEFGH_SFstatDown[entry.event_Lepton_idx])*float(entry.Electron_IDISO_BCDEFGH_SFsystDown[entry.event_Lepton_idx])/float(idisosf)
            evtwt_Ele_RECO_Sf_Down      *= float(entry.Electron_RECO_BCDEFGH_SFstatDown[entry.event_Lepton_idx])*float(entry.Electron_RECO_BCDEFGH_SFsystDown[entry.event_Lepton_idx])/float(recosf)
            evtwt_Ele_Trig_Sf_Down      *= float(Ele_trig_SF(entry.Electron_eta[el], entry.Electron_pt[el],"Down"))/float(trigsf)
          ...
          if (float(entry.event_Event_flag) == 13 and float(entry.event_MuonTrigFlag) >= 1):
            ...
            evtwt *= (float(idsf)*float(isosf)*float(trigsf))
            #guru
            evtwt_Mu_ID_Sf_Up *= float(entry.Muon_ID_BCDEF_SFstatUp[entry.event_Lepton_idx])*float(entry.Muon_ID_BCDEF_SFsystUp[entry.event_Lepton_idx])/float(idsf)
            evtwt_Mu_ISO_Sf_Up *= float(entry.Muon_ISO_BCDEF_SFstatUp[entry.event_Lepton_idx])*float(entry.Muon_ISO_BCDEF_SFsystUp[entry.event_Lepton_idx])/float(isosf)
            evtwt_Mu_Trig_Sf_Up *= float(entry.Muon_Trigger_BCDEF_SFstatUp[entry.event_Lepton_idx])*float(entry.Muon_Trigger_BCDEF_SFsystUp[entry.event_Lepton_idx])/float(trigsf)
            #guru
            evtwt_Mu_ID_Sf_Down *= float(entry.Muon_ID_BCDEF_SFstatDown[entry.event_Lepton_idx])*float(entry.Muon_ID_BCDEF_SFsystDown[entry.event_Lepton_idx])/float(idsf)
            evtwt_Mu_ISO_Sf_Down *= float(entry.Muon_ISO_BCDEF_SFstatDown[entry.event_Lepton_idx])*float(entry.Muon_ISO_BCDEF_SFsystDown[entry.event_Lepton_idx])/float(isosf)
            evtwt_Mu_Trig_Sf_Down *= float(entry.Muon_Trigger_BCDEF_SFstatDown[entry.event_Lepton_idx])*float(entry.Muon_Trigger_BCDEF_SFsystDown[entry.event_Lepton_idx])/float(trigsf)
            ...
            for el in range(0, entry.nElectron):
              ...
              evtwt  *= (float(idisosf)*float(recosf)*float(trigsf))
            #guru
            evtwt_Ele_IDISO_Sf_Up     *= float(entry.Electron_IDISO_BCDEF_SFstatUp[entry.event_Lepton_idx])*float(entry.Electron_IDISO_BCDEF_SFsystUp[entry.event_Lepton_idx])/float(idisosf)
            evtwt_Ele_RECO_Sf_Up      *= float(entry.Electron_RECO_BCDEF_SFstatUp[entry.event_Lepton_idx])*float(entry.Electron_RECO_BCDEF_SFsystUp[entry.event_Lepton_idx])/float(recosf)
            evtwt_Ele_Trig_Sf_Up      *= float(Ele_trig_SF(entry.Electron_eta[el], entry.Electron_pt[el],"Up"))/float(trigsf)
            ...
            #guru
            evtwt_Ele_IDISO_Sf_Down     *= float(entry.Electron_IDISO_BCDEF_SFstatDown[entry.event_Lepton_idx])*float(entry.Electron_IDISO_BCDEF_SFsystDown[entry.event_Lepton_idx])/float(idisosf)
            evtwt_Ele_RECO_Sf_Down      *= float(entry.Electron_RECO_BCDEF_SFstatDown[entry.event_Lepton_idx])*float(entry.Electron_RECO_BCDEF_SFsystDown[entry.event_Lepton_idx])/float(recosf)
            evtwt_Ele_Trig_Sf_Down      *= float(Ele_trig_SF(entry.Electron_eta[el], entry.Electron_pt[el],"Down"))/float(trigsf)
          if (isTTJet(file) and applyTopPtRew): 
            #topptweight=float(entry.TopPt_Weight_Nominal)
            #topptweight= topPt_Reweighting(file, entry, 0.0615*2.11, 0.0005*0.514)
          ...
          if (float(entry.event_Event_flag) == 13 and float(entry.event_MuonTrigFlag) >= 1):
            ...
            evtwt *= (float(idsf)*float(isosf)*float(trigsf))
            #guru
            evtwt_Mu_ID_Sf_Up *= float(entry.Muon_ID_ABCD_SFstatUp[entry.event_Lepton_idx])*float(entry.Muon_ID_ABCD_SFsystUp[entry.event_Lepton_idx])/float(idsf)
            evtwt_Mu_ISO_Sf_Up *= float(entry.Muon_ISO_ABCD_SFstatUp[entry.event_Lepton_idx])*float(entry.Muon_ISO_ABCD_SFsystUp[entry.event_Lepton_idx])/float(isosf)
            ...
            evtwt_Mu_Trig_Sf_Up *= float(((trigsfBefore_Up*7.0) + (trigsfAfter_Up*53.0))/60.0)/float(trigsf)
            #guru
            evtwt_Mu_ID_Sf_Down *= float(entry.Muon_ID_ABCD_SFstatDown[entry.event_Lepton_idx])*float(entry.Muon_ID_ABCD_SFsystDown[entry.event_Lepton_idx])/float(idsf)
            evtwt_Mu_ISO_Sf_Down *= float(entry.Muon_ISO_ABCD_SFstatDown[entry.event_Lepton_idx])*float(entry.Muon_ISO_ABCD_SFsystDown[entry.event_Lepton_idx])/float(isosf)
            ...
            evtwt_Mu_Trig_Sf_Down *= float(((trigsfBefore_Down*7.0) + (trigsfAfter_Down*53.0))/60.0)/float(trigsf)
            ...
            for el in range(0, entry.nElectron):
              ...
              evtwt  *= (float(idisosf)*float(recosf)*float(trigsf))
            #guru
            evtwt_Ele_IDISO_Sf_Up     *= float(entry.Electron_IDISO_ABCD_SFstatUp[entry.event_Lepton_idx])*float(entry.Electron_IDISO_ABCD_SFsystUp[entry.event_Lepton_idx])/float(idisosf)
            evtwt_Ele_RECO_Sf_Up      *= float(entry.Electron_RECO_ABCD_SFstatUp[entry.event_Lepton_idx])*float(entry.Electron_RECO_ABCD_SFsystUp[entry.event_Lepton_idx])/float(recosf)
            evtwt_Ele_Trig_Sf_Up      *= float(Ele_trig_SF(entry.Electron_eta[el], entry.Electron_pt[el],"Up"))/float(trigsf)        
            #guru
            evtwt_Ele_IDISO_Sf_Down     *= float(entry.Electron_IDISO_ABCD_SFstatDown[entry.event_Lepton_idx])*float(entry.Electron_IDISO_ABCD_SFsystDown[entry.event_Lepton_idx])/float(idisosf)
            evtwt_Ele_RECO_Sf_Down      *= float(entry.Electron_RECO_ABCD_SFstatDown[entry.event_Lepton_idx])*float(entry.Electron_RECO_ABCD_SFsystDown[entry.event_Lepton_idx])/float(recosf)
            evtwt_Ele_Trig_Sf_Down      *= float(Ele_trig_SF(entry.Electron_eta[el], entry.Electron_pt[el],"Down"))/float(trigsf)
      ...
      if (doSys):
        ...
        #guru
        evtwt_Ele_IDISO_Sf_Up = evtwt_nominal*evtwt_Ele_IDISO_Sf_Up
        evtwt_Ele_IDISO_Sf_Down = evtwt_nominal*evtwt_Ele_IDISO_Sf_Down
        evtwt_Ele_RECO_Sf_Up = evtwt_nominal*evtwt_Ele_RECO_Sf_Up
        evtwt_Ele_RECO_Sf_Down = evtwt_nominal*evtwt_Ele_RECO_Sf_Down
        evtwt_Mu_Trig_Sf_Up = evtwt_nominal*evtwt_Mu_Trig_Sf_Up
        evtwt_Mu_Trig_Sf_Down = evtwt_nominal*evtwt_Mu_Trig_Sf_Down
        evtwt_Mu_ID_Sf_Up = evtwt_nominal*evtwt_Mu_ID_Sf_Up
        evtwt_Mu_ID_Sf_Down = evtwt_nominal*evtwt_Mu_ID_Sf_Down
        evtwt_Mu_ISO_Sf_Up = evtwt_nominal*evtwt_Mu_ISO_Sf_Up
        evtwt_Mu_ISO_Sf_Down = evtwt_nominal*evtwt_Mu_ISO_Sf_Down
        #print("evtwt_Ele_IDISO_Sf_Up: ",evtwt_Ele_IDISO_Sf_Up)

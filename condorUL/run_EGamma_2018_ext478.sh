...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/EGamma/Run2018B-02Apr2020-v1/210810_035242/0000/tree_22.root  --datayear 2018 --outputfile $1_EGamma_2018_ext478.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_EGamma_2018_ext478.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_EGamma_2018_ext478.root 

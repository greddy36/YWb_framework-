...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2016-VER2/TTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8_ext1-v1/210907_030003/0000/tree_2.root  --datayear 2016 --outputfile $1_TTWJetsToLNu_2016_ext1839.root --nque 5 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/SAMPLE" 

xrdcp -f $1_TTWJetsToLNu_2016_ext1839.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2016/$1_TTWJetsToLNu_2016_ext1839.root 

...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/SingleMuon/Run2018D-Nano25Oct2019-v1/210904_175602/0000/tree_20.root  --datayear 2018 --outputfile $1_SingleMuon_2018_ext3630.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_SingleMuon_2018_ext3630.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_SingleMuon_2018_ext3630.root 

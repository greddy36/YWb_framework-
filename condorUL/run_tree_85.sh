...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2017-VER2/WJetsToLNu_Pt-50To100_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_102X_mc2017_realistic_v8-v1/210918_054928/0000/tree_85.root  --datayear 2017 --outputfile $1_tree_85.root  --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/SAMPLE" 

xrdcp -f $1_tree_85.root  root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2017/$1_tree_85.root  

...
for i in  range(1):
  ...
  systematicS = ["nominal"]
  if (doSys):#guru
    systematicS = ["nominal", "PileupUp", "PileupDown", "BTaghfSFUp", "BTaghfSFDown", "BTaglfSFUp", "BTaglfSFDown", "topptweightUp", "topptweightDown", "jerUp", "jerDown", "jesUp", "jesDown", "jer16Up", "jer16Down", "jes16Up", "jes16Down", "jer17Up", "jer17Down", "jes17Up", "jes17Down","jer18Up", "jer18Down", "jes18Up", "jes18Down", "LHEScale1", "LHEScale2", "LHEScale3", "LHEScale4", "LHEScale6", "LHEScale8", "LHEScaleUpWeight", "LHEScaleDownWeight", "LHEPdfUpWeight", "LHEPdfDownWeight","TTJets_ST_ScalingUp", "TTJets_ST_ScalingDown", "NoPileup"]
    ...
    if (doSys):#guru
      for cr in range(len(controlR)):
        ...
        if ('Mu' in CHL or 'Ele' in CHL): 
          if (year == "2016"):
            if (int(cutjerUp) == 17):   
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerUp"), MET_phi(file, entry, "jerUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerUp"),  "jerUp", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerUp"), MET_phi(file, entry, "jerUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerUp"),  "jer16Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),  "jer17Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),  "jer18Up", evtwt_nominal)
            if (int(cutjerDown) == 17):
              ...
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerDown"), MET_phi(file, entry, "jerDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerDown"), "jer16Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jer17Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jer18Down", evtwt_nominal)
            if (int(cutjesUp) == 17):
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesUp"), MET_phi(file, entry, "jesUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesUp"), "jesUp", evtwt_nominal)   
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesUp"), MET_phi(file, entry, "jesUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesUp"), "jes16Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jes17up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jes18Up", evtwt_nominal)
            if (int(cutjesDown) == 17): 
              ...
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesDown"), MET_phi(file, entry, "jesDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesDown"),"jes16Down", evtwt_nominal)
            fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),"jes17Down", evtwt_nominal)
            fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),"jes18Down", evtwt_nominal)
          if (year == "2017"):
            if (int(cutjerUp) == 17):  
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerUp"), MET_phi(file, entry, "jerUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerUp"),  "jerUp", evtwt_nominal) 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerUp"), MET_phi(file, entry, "jerUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerUp"),  "jer17Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),  "jer16Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),  "jer18Up", evtwt_nominal)
            if (int(cutjerDown) == 17): 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerDown"), MET_phi(file, entry, "jerDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerDown"), "jerDown", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerDown"), MET_phi(file, entry, "jerDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerDown"), "jer17Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jer16Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jer18Down", evtwt_nominal)
            if (int(cutjesUp) == 17):  
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesUp"), MET_phi(file, entry, "jesUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesUp"), "jesUp", evtwt_nominal) 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesUp"), MET_phi(file, entry, "jesUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesUp"), "jes17Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jes16up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jes18Up", evtwt_nominal)
            if (int(cutjesDown) == 17): 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesDown"), MET_phi(file, entry, "jesDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesDown"),"jesDown", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesDown"), MET_phi(file, entry, "jesDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesDown"),"jes17Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),"jes16Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),"jes18Down", evtwt_nominal)
          if (year == "2018"):
            if (int(cutjerUp) == 17):
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerUp"), MET_phi(file, entry, "jerUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerUp"),  "jerUp", evtwt_nominal)   
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerUp"), MET_phi(file, entry, "jerUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerUp"),  "jer18Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),  "jer17Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),  "jer16Up", evtwt_nominal)
            if (int(cutjerDown) == 17):
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerDown"), MET_phi(file, entry, "jerDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerDown"), "jerDown", evtwt_nominal) 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jerDown"), MET_phi(file, entry, "jerDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jerDown"), "jer18Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jer17Down", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjerDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jer16Down", evtwt_nominal)
            if (int(cutjesUp) == 17):  
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesUp"), MET_phi(file, entry, "jesUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesUp"), "jesUp", evtwt_nominal) 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesUp"), MET_phi(file, entry, "jesUp"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesUp"), "jes18Up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jes17up", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesUp)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"), "jes16Up", evtwt_nominal)
            if (int(cutjesDown) == 17): 
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesDown"), MET_phi(file, entry, "jesDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesDown"),"jesDown", evtwt_nominal)
              fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "jesDown"), MET_phi(file, entry, "jesDown"), Jet_pt(file, entry, entry.event_LeadJet_idx, "jesDown"),"jes18Down", evtwt_nominal)
            fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),"jes17Down", evtwt_nominal)
            fillHisto(str(controlR[cr]), CHL, file, entry, int(cutjesDown)-1, nBTag, MassT, HT_Central, leadjetBTagTig, bdtOutput, HEMwt, nCentralJets_v2, dR_lepClosestJet_v2, FwdJetPt_L, FwdJetPt_M, FwdJetPt_T, MET_pt(file, entry, "nominal"), MET_phi(file, entry, "nominal"), Jet_pt(file, entry, entry.event_LeadJet_idx, "nominal"),"jes16Down", evtwt_nominal)

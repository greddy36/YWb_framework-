...
python analyse_with_mva_batch.py --inputfile root://cmsxrootd.fnal.gov//store/user/greddy/NanoAOD2018-VER2/TprimeBToBW_M-2000_TuneCP5_13TeV-madgraph-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_102X_upgrade2018_realistic_v21-v1/210907_041934/0000/tree_1.root  --datayear 2018 --outputfile $1_TprimeBToBW_M-2000_2018_ext4411.root --nque 1 --npro $1 


echo "xrdcp *.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/SAMPLE" 

xrdcp -f $1_TprimeBToBW_M-2000_2018_ext4411.root root://cmseos.fnal.gov//store/user/greddy/NanoPostProc_test/2018/$1_TprimeBToBW_M-2000_2018_ext4411.root 
